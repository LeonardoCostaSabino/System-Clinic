      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li id="Home_link">
                  <a href="../Controller/Rotas.php?rota=Home" ><i class="fa fa-home"></i> Home</a>
                </li>
                <li>
                  <a><i class="fa fa-edit"></i> Nome <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li id="Paciente_link" >
                      <a href="../Controller/Rotas.php?rota=Paciente" ><i class="fa fa-child" aria-hidden="true"></i>Pacientes</a>
                    </li>
                    <li>
                      <a><i class="fa fa-book"></i>Consultas</a>
                      <ul class="nav child_menu">
                        <li id="Agendamento_link">
                          <a href="../Controller/Rotas.php?rota=Agendamento" ><i class="fa fa-calendar-check-o"></i>Agendamento de consultas</a>
                        </li>
                        <li id="Visualizar_link">
                          <a href="../Controller/Rotas.php?rota=Visualizar_con" ><i class="fa fa-calendar"></i>Visualizar consultas</a>
                        </li>
                      </ul>
                    </li>
                    <li id="Funcionario_link" >
                      <a href="../Controller/Rotas.php?rota=Funcionario" ><i class="fa fa-user"></i>Funcionários</a>
                    </li>
                    <li id="Prontuario_link" ><a href="../Controller/Rotas.php?rota=Prontuario" ><i class="fa fa-file-o"></i>Prontuário</a></li>
                    <li id="Clinicas_link" ><a href="../Controller/Rotas.php?rota=Clinicas" ><i class="fa fa-hospital-o"></i>Clinicas</a></li>
                    <li id="Dicom_link"><a href="../Controller/Rotas.php?rota=Dicom" ><i class="fa fa-camera-retro"></i>Dicom</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-file-text-o"></i> Relatórios <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li id="Pdf1_link"><a href="../Controller/Rotas.php?rota=pdf1">Relatório.PDF</a></li>
                    <li id="Pdf2_link"><a href="../Controller/Rotas.php?rota=pdf2">Relatório.PDF</a></li>
                  </ul>
                </li>
                <li>
                  <a>
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li>
                  ...
                  <ul class="nav child_menu">
                    <li><a href="../Controller/Rotas.php?rota=Agendamento_con">Pagina de Agendamento</a></li>
          ...
          <div class="sidebar-footer hidden-small">
            ...
            <a data-toggle="tooltip" data-placement="top" title="Logout" href="../Controller/Rotas.php?rota=Logout" id="Logout_Bar">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                ...
                <ul class="dropdown-menu dropdown-usermenu pull-right">
                  ...
                  <li><a href="../Controller/Rotas.php?rota=Logout" class="fa fa-sign-out pull-right"></i> Sair</a></li>
                </ul>
              </li>
              <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                <li>
                  <a>
                    <span class="image"><img src="../Imagens/Formularios/img.jpg" alt="Profile Image" ></span>
                  </a>
                </li>
                <li>
