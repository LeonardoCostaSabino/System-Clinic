...
app.use('/models', express_1.default.static(__dirname + '/Public'));
app.get("/ping", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var database;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.query("SELECT 1 + 1").then(function () { return "up"; }).catch(function () { return "down"; })];
            case 1:
                database = _a.sent();
                res.send({
